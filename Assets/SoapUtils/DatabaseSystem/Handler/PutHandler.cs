...
namespace SoapUtils.DatabaseSystem
{
    internal class PutHandler
    {
        ...
        public async UniTask<string> Put(int domainIndex, string api, object data)
        {
        ...
        public async UniTask<string> Put(int domainIndex, string api, string token, object data)
        {
            var req = SetRequest(domainIndex, api, data);
